...
from loreleai.language.lp import Constant, Variable, Functor, Structure, Predicate, List, Atom, Not, Clause, \
    c_const, c_functor, c_pred
...
def _cl_to_swipy(clause: Clause, lit_var_store: Dict[Variable, int]):
    body: typing.Sequence[Union[Atom, Not]] = clause.get_literals()
    head: Atom = clause.get_head()

    body: typing.Sequence[int] = [_lit_to_swipy(x, lit_var_store)
