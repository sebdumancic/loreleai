...
p18_2(A,B):-skip1(A,C),p1133_1(C,B).
...
p139(A,B):-p58_1(A,C),p139_1(C,B).
p139_1(A,B):-p116(A,C),p58_1(C,B).
...
p337(A,B):-p9_1(A,C),p337_1(C,B).
p337_1(A,B):-p651(A,C),p928_1(C,B).
...
p481(A,B):-p52_1(A,C),p481_1(C,B).
p481_1(A,B):-p172(A,C),mk_lowercase(C,B).
...
p616_1(A,B):-p552_1(A,C),p616_2(C,B).
...
p643(A,B):-p88_1(A,C),p643_1(C,B).
p643_1(A,B):-p172(A,C),p138(C,B).
...
p712(A,B):-p88_1(A,C),p712_1(C,B).
p712_1(A,B):-skip1(A,C),p58(C,B).
...
p778(A,B):-is_number(A),p205_1(A,B).
p778(A,B):-skip1(A,C),p778(C,B).
p780(A,B):-p116(A,C),p780_1(C,B).
p780_1(A,B):-skip1(A,C),p1096(C,B).
p784(A,B):-p116(A,C),p60(C,B).
p785(A,B):-p9_1(A,C),p785_1(C,B).
p785_1(A,B):-skip1(A,C),p58(C,B).
...
p1155(A,B):-p9_1(A,C),p1155_1(C,B).
p1155_1(A,B):-skip1(A,C),p58(C,B).
...
p377_1(A,B):-p893(A,C),p132_1(C,B).
